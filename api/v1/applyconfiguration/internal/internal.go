...
- name: com.github.helmetica-framework.chrysopoeia.api.v1.CustomResourceDefinitionSource
  scalar: untyped
  list:
    elementType:
...
- name: com.github.helmetica-framework.chrysopoeia.api.v1.InstanceRevision
  ...
  map:
    elementType:
      namedType: __untyped_deduced_
    elementRelationship: separable
- name: com.github.helmetica-framework.chrysopoeia.api.v1.OperatorHarness
  map:
    fields:
    - name: apiVersion
      type:
    ...
    - name: spec
      type:
        namedType: com.github.helmetica-framework.chrysopoeia.api.v1.OperatorHarnessSpec
    - name: status
      type:
        namedType: com.github.helmetica-framework.chrysopoeia.api.v1.OperatorHarnessStatus
- name: com.github.helmetica-framework.chrysopoeia.api.v1.OperatorHarnessOperator
  map:
    fields:
    - name: injectProxyConfiguration
      type:
        scalar: boolean
    - name: namespace
      type:
      ...
      type:
        list:
          elementType:
            scalar: string
          elementRelationship: atomic
- name: com.github.helmetica-framework.chrysopoeia.api.v1.OperatorHarnessSpec
  map:
    fields:
    - name: operator
      type:
        namedType: com.github.helmetica-framework.chrysopoeia.api.v1.OperatorHarnessOperator
    - name: scopeToLabel
      type:
        scalar: string
- name: com.github.helmetica-framework.chrysopoeia.api.v1.OperatorHarnessStatus
  map:
    fields:
    - name: conditions
      type:
